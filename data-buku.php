            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
				  ...
				  <a href="tambah-buku.php" class="btn btn-success float-right"> <i class="fas fa-plus"></i> TAMBAH BUKU</a>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  <tr>
					...
					<td> 
					<a href="edit-buku.php?id=<?php echo $data['id_buku']; ?>" class="btn btn-warning"> <i class="fas fa-pencil-alt"></i> EDIT</a> &nbsp; &nbsp; &nbsp; 
					<a href="proses-hapus.php?id=<?php echo $data['id_buku']; ?>" 
